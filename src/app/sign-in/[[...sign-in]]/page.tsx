            ...
            <div className="space-y-2">
              ...
              >
                ...
                >
                  <path
                    fill="currentColor"
                    d="M19.9 36.1c-.2 0-.4-.1-.5-.3L9 15.8h6.4l4.2 15.2c.1.3-.2.6-.5.6zm.2 0c.2 0 .4-.1.5-.3l10.4-20H23.7l-3.6 13.2c-.1.2.2.5.5.5zM8.9 15.7 5.5 5.7c-.1-.3-.5-.3-.6 0L.2 20.6c-.1.3 0 .6.2.8L19.5 39c.1.1.2.1.3.1.1 0 .2 0 .3-.1l19-17.5c.2-.2.3-.5.2-.8l-4.7-14.8c-.1-.3-.5-.3-.6 0l-3.4 10H8.9z"
                  />
                </svg>
                Login with GitLab
              </Clerk.Connection>
