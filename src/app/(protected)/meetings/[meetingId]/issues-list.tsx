...
const IssuesList = ({meetingId}: Props) => {
    ...
    return (
        <>
            <div className="p-8">
                <div className=" mx-auto flex max-w-2xl intems-center justify-between gap-x-8 border-b pg-6 lg:mx-0 lg:max-w-none">
...
function IssuesCard({issue}: {issue: NonNullable<RouterOutputs["project"]["getMeetingById"]>["issues"][number]}) {
